...
import { environment } from 'projects/nfc/src/environments/environment';
import { HttpUtilsService } from 'projects/nfc/src/app/helpers/global/services/http-utils.service';

const API_ROOT_URL = environment.ApiRoot + '/common';
const API_WC_URL = environment.ApiRoot_WC + '/dungchung';
